...
function Footer() {
    return (
        <div className=" text-white   p-8 dark:bg-[#0f0f0f] bg-[#ee3453] z-50 w-full transition-all ease-in duration-500 shadow-md dark:border-[#fae800] border-t-white border-t-2 h-auto">
            <div className='container m-auto w-2/3'>
                <div className='justify-center flex-col md:flex-row flex items-center md:flex sm:items-center md:justify-between'>
                    <span className='text-md text-white sm:text-center '>
                        &copy; 2023 All Rights Reserved.
                    </span>
                    <div className='flex mt-4 space-x-6 md:justify-center md:mt-0'>
                        <a href='https://github.com/necrydark/nextjs-portfolio2' className='hover:text-[#fae800] ease-in transition-colors duration-300'>
                            <p className='text-md'>Designed and made with ♥ by Michael Connor</p>
                        </a>
                    </div>
                    {/* <div className='flex mt-4 space-x-6 md:justify-center md:mt-0 '>
                <a href="https://www.facebook.com/mikey.connor.71/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#fae800] transition-colors duration-300 ease-in p-[10px]">
                ...
                <a href="https://www.instagram.com/necrydark/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#fae800] transition-colors duration-300 ease-in p-[10px]">
                ...
                <a href="https://twitter.com/mikeykconnor" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#fae800] transition-colors duration-300 ease-in p-[10px]">
                ...
                <a href="https://github.com/necrydark" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#fae800] transition-colors ease-in duration-300 p-[10px]">
